<template>
  <div class="music">
    <div class="music-content">
      ...
      <ucraftLyric class="music-right" :lyric="lyric" :nolyric="nolyric" :lyricIndex="lyricIndex"/>
    </div>
    ...
    <div class="music-bar" :class="{disable:!musicReady||!currentMusic.id}">
      ...
      <div class="music-bar-volume" title="音量加减 [Ctrl+Up/Down]">
        ...
        <ucraftProgress @percentChange="volumeChange" :percent="volume"/>
      </div>
    </div>
