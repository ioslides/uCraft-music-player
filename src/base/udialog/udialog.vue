<template>
    ...
    <transition name="udialog-fade">
        <div class="udialog-box" v-show="dialogShow">
            <div class="udialog-wrapper">
                <div class="udialog-content">
                    <div class="udialog-head" v-text="headText"></div>
                    <slot>
                        <div class="udialog-text" v-html="bodyText"></div>
                    </slot>
                    <div class="udialog-btns">
...
<style lang="less">
    ...
    .@{dialog-prefix-cls}-box {
        ...
        &.@{dialog-prefix-cls}-fade-enter-active {
            animation: udialog-fadein 0.3s;
            .@{dialog-prefix-cls}-content {
                animation: udialog-zoom 0.3s;
            }
        }
